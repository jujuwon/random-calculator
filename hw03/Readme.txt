...
6. Error or Additional message Handling
 ...
 - 클라이언트
  - 멀티쓰레딩 환경에서 클라이언트 간 메시지를 주고 받고, 동시성 문제를 해결하기 위해 synchronized 를 활용하였습니다.
  - Logging 을 위한 File IO 시, IOException 이 발생하면 stackTrace 를 출력하도록 예외처리를 하였습니다.


7. Additional Comments
 - 파일 이름은 A, B, C, D 대신 1, 2, 3, 4로 수정하여 진행하였습니다.

 - ./file/client3 디렉토리에 3.file을 ./file/client4 디렉토리에 4.file을 위치시키고 실행시켜야 합니다.
